...
export const mockPosts: PostRec[] = [
    {
        ...
        tags: ['bug'],
        text: 'Hi there. Not certain this is a bug or a feature but your lazy-loaded pages seem to be a bit too lazy ;).',
    ...
    },
    {
        ...
        tags: ['question'],
        text: `Hi. I'd like to know what the guidelines are for for collaborating  on this project. Specifically how architecture designs are decided.`,
